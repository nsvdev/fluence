...
const Button = ({
    ...
    if (type === 'small' && opacity === true) return <button className={`${styles.button} ${styles.button_height_small} ${styles.button_opacity}`} onClick={callback}>{text}</button>
    ...
    if (type === 'large' && icon === 'twitter') return <button className={`${styles.button} ${styles.button_height_large} ${styles.button_icon} ${styles.button_icon_twitter}`} onClick={callback}>{text}</button>

    if (type === 'large' && opacity === true) return <button className={`${styles.button} ${styles.button_height_large} ${styles.button_opacity}`} onClick={callback}>{text}</button>
