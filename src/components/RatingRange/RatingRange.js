    ...
    return(
        <div className={styles.container}>
            <div className={styles.range}>
                <span className={`${styles.count} ${styles.count_nice}`}>{roundNumber(nice)}</span>
                <div className={styles.range__body}>
                    <span  style={style} />
                </div>
                <span className={`${styles.count} ${styles.count_bad}`}>{roundNumber(bad)}</span>
            </div>
            <span className={`${styles.count} ${styles.count_total}`}>{roundNumber(nice + bad)} votes</span>
        </div>
    )
}
